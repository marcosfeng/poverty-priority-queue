...
## Dynamic Programming Simulation Code
...
```{r cost-model, eval=FALSE, include=TRUE}
...
### ATTENTION
## Requires some data from Dynamic_Programming.R

setwd("/Users/marcosgallo/Documents/Marcos PhD Files/Poverty/PrioQ-exp-results/")
load("cooked/prolific1.Rdata")
...
# option-state: an easy way to map the choices for choice prob calculation
...
## Create an easy way to map choices to states
...
# save(model_data, ch_opt_translation, file = "cooked/prolific1StanData.Rdata")
...
Prolific1_Stan_results <- sampling(object = my_model, data = model_data,
                                   ...
                                   chains = 1,
                                   cores = 3)
# save(Prolific1_Stan_results, file = "cooked/Prolific1StanResults.Rdata")
