...
pglm(formula = Urgency ~ Dim.1*Dim.2 +
                         age + education,
...
pglm(formula = Urgency ~ income*stai +
                         age + education,
     data = trade_off_accuracy,
     effect = "twoways",
     index = c("participant", "round"),
...
pglm(formula = Urgency ~ S1701_C03_001E*stai +
                         age + education,
     data = trade_off_accuracy,
     effect = "twoways",
     index = c("participant", "round"),
...
pglm(formula = Urgency ~ S1903_C03_001E*stai +
                         age + education,
     data = trade_off_accuracy,
     effect = "twoways",
     index = c("participant", "round"),
...
summary(glm(formula = as.numeric(RT) ~ Dim.1*Dim.2 + age + education, data = trade_off_accuracy, family = "gaussian"))
summary(glm(formula = as.numeric(RT) ~ S1701_C03_001E*stai + age + education, data = trade_off_accuracy, family = "gaussian"))
summary(glm(formula = as.numeric(RT) ~ Dim.1*stai*Dim.2 + age + education, data = trade_off_accuracy, family = "gaussian"))
summary(glm(formula = as.numeric(RT) ~ S1903_C03_001E*stai, + age + education data = trade_off_accuracy, family = "gaussian"))
```
...
```{r}
#| label: tbl-accuracy
summary(pglm(formula = Optimal ~ income*stai +
                         age + education,
             data = trade_off_accuracy,
             effect = "twoways",
             index = c("participant", "round"),
...
summary(pglm(formula = Optimal ~ Dim.1*Dim.2 +
                         age + education,
             data = trade_off_accuracy,
             effect = "twoways",
             index = c("participant", "round"),
...
summary(pglm(formula = Optimal ~ poverty_zip*stai +
                         age + education,
             data = trade_off_accuracy,
             effect = "twoways",
             index = c("participant", "round"),
...
summary(pglm(formula = Optimal ~ median_income_zip*stai +
                         age + education,
             data = trade_off_accuracy,
             effect = "twoways",
             index = c("participant", "round"),
