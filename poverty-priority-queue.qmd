...
# Creating the plot
plot(demograph$income, demograph$Dim.1, pch = 19, col = "lightblue",
     xlab="Income", ylab="Dimension 1")
# Regression line
abline(lm(demograph$Dim.1 ~ demograph$income), col = "red", lwd = 3)
# Pearson correlation
text(paste("Correlation:", round(cor(demograph$Dim.1, demograph$income, use = "complete.obs"), 2)), x = 6, y = .7)

plot(demograph$income, demograph$Dim.2, pch = 19, col = "lightblue",
     xlab="Income", ylab="Dimension 2")
# Regression line
abline(lm(demograph$Dim.2 ~ demograph$income), col = "red", lwd = 3)
# Pearson correlation
text(paste("Correlation:", round(cor(demograph$Dim.2, demograph$income, use = "complete.obs"), 2)), x = 6, y = .7)
########
plot(demograph$stai, demograph$Dim.1, pch = 19, col = "lightblue",
     xlab="Anxiety", ylab="Dimension 1")
# Regression line
abline(lm(demograph$Dim.1 ~ demograph$stai), col = "red", lwd = 3)
# Pearson correlation
text(paste("Correlation:", round(cor(demograph$Dim.1, demograph$stai, use = "complete.obs"), 2)), x = 40, y = -2)

plot(demograph$stai, demograph$Dim.2, pch = 19, col = "lightblue",
     xlab="Anxiety", ylab="Dimension 2")
# Regression line
abline(lm(demograph$Dim.2 ~ demograph$stai), col = "red", lwd = 3)
# Pearson correlation
text(paste("Correlation:", round(cor(demograph$Dim.2, demograph$stai, use = "complete.obs"), 2)), x = 40, y = .7)
...
summary(pglm(formula = Optimal ~ age + as.numeric(education) + as.numeric(income),
             ...
             model = "random",
             family = binomial('logit')))
trade_off_accuracy <- trade_off_accuracy %>%
  ungroup() %>%
  mutate(poverty_zip = scale(S1701_C03_001E),
         median_income_zip = scale(S1903_C03_001E))
